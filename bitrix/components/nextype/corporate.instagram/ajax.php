...
try
{
	$template = $signer->unsign($request->get('template'), 'corporate.instagram');
	$paramString = $signer->unsign($request->get('parameters'), 'corporate.instagram');
}
