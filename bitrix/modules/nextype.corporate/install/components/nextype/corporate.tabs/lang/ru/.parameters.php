...
$MESS["IBLOCK_PROPERTY_TAGS"] = "Отображать товары, которые содержат метки";
$MESS["IBLOCK_ELEMENT_COUNT"] = "Количество элементов для отображения";
$MESS["CP_BC_TPL_LABEL_PROP"] = "Свойство меток товара";
$MESS["CP_BC_PROPERTY_TAGS"] = "Метки товара";
$MESS["CP_BC_PROPERTY_PRICE"] = "Свойство с ценой товара";
$MESS["CP_BC_PROPERTY_OLD_PRICE"] = "Свойство старой цены ";
$MESS["CP_DISPLAY_IN_STOCK"] = "Отображать метку наличия";